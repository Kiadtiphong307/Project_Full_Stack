            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="bg-gray-200 bg-opacity-25 grid grid-cols- md:grid-cols-2 gap-8 lg:gap-78p-6 lg:p-10 p-9"> 
                                    ...
                                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" v-for=" (product,index ) in products" :key="index">
                        ...
                        <div class="mt-5 text-gray-500 text-sm leading-relaxed" ><h6></h6>
